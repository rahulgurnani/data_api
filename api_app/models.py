...
class FoodPermit(models.Model):
	...
	locationdescription = models.CharField(max_length=800, blank=True, default='')
	address = models.CharField(max_length=800, blank=True, default='')
	...
	fooditems = models.CharField(max_length=800, blank=True, default='')
	x = models.DecimalField(max_digits=15, decimal_places=4, null=True)
	...
	schedule = models.CharField(max_length=800, blank=True, default='')
